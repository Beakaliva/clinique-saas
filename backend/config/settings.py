...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        ...
        'users.permissions.ClinicAccessPermission',
    ),
...
DEFAULT_FROM_EMAIL  = config('DEFAULT_FROM_EMAIL',  default='ClinicPro <noreply@clinicpro.net>')

# En développement, écrire les emails dans la console
